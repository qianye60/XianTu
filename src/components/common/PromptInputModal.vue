    ...
    <div class="modal-content" @click.stop>
      ...
      <div class="modal-body">
        <div class="prompt-section">
          <label class="prompt-label">自定义提示词</label>
          <p class="prompt-hint">{{ hintText }}</p>
          <textarea 
            v-model="userPrompt"
            class="prompt-input"
...
const hintText = computed(() => {
  const hints = {
    world: '描述你希望的世界风格、时代背景或特色设定',
    talent_tier: '描述你希望的天资类型、特点或能力倾向',  
    origin: '描述你希望的出身背景、家族或成长环境',
    spirit_root: '描述你希望的灵根属性、特色或修炼倾向',
    talent: '描述你希望的天赋能力、特殊技能或神通'
  };
...
const confirm = () => {
  ...
  emit('confirm', userPrompt.value.trim());
  userPrompt.value = '';
};
