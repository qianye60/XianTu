...
\`\`\`json
{
  ...
  "敏感度": 0-100,
  "开发程度": 0-100,
  "特殊标记": "string (可选，如: 淫纹、咬痕)",
  "描述": "string (外观和感觉的详细描述)"
}
\`\`\`
...
│       【操作方式】用set更新部位对象: {"action":"set","key":"身体部位开发.阴道","value":{"描述":"粉嫩紧致，轻触即颤","开发等级":30,"敏感度":65,"特殊标记":"已开发"}}
...
2. 【私密信息字段】根据系统设置决定是否生成
   ...
   - 【示例】若nsfwGenderFilter="female"且当前NPC性别="女"，则必须生成完整私密信息
...
| 化神 | 5000年 | 初期/中期/后期/圆满/极境 | 神游太虚、感悟法则 |
| 炼虚 | 10000年+ | 初期/中期/后期/圆满/极境 | 身融虚空、缩地成寸 |
| 合体 | 与世同君 | 初期/中期/后期/圆满/极境 | 法则归体、身即是道 |
| 渡劫 | 不定(劫数) | 初期/中期/后期/圆满/极境 | 超脱世界、叩问天道 |
