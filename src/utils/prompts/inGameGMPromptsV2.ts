...
export const IN_GAME_MESSAGE_PROMPT = [
  ...
  '格式要求:',
  '- text: 必须是字符串类型，长度≥400字，建议2-5段，不能为null或undefined',
  ...
  '- 记忆: 短期记忆[]/中期记忆[]/长期记忆[]（元素为字符串）；人物关系: 人物关系.<姓名>=NpcProfile；',
  '',
  '物品规范:',
  ...
  '  * 示例: {"丹药名":{物品ID:"丹药名",名称:"丹药名",类型:"其他",品质:{quality:"凡",grade:3},数量:5,描述:"..."}}',
  '- NPC交互场景:',
  ...
  '',
  '记忆管理:',
  '- 短期记忆: 格式"[时辰][地点]事件"，保持5-10条',
  '- 中期记忆: 格式"[日期]要事总结"，每10条短期总结为1条',
  '- 自动归档: 超过上限时总结旧记忆，保持精简',
  '',
  '最小指令集（发生相应变化时，需至少包含）:',
  "- set: character.saveData.玩家角色状态.位置.(描述|坐标)",
  "- push: character.saveData.记忆.(短期记忆|中期记忆)",
