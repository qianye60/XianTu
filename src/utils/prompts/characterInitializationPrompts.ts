...
const CHARACTER_INIT_RULES = [
  ...
  '',
  '🔥🔥🔥 **NSFW内容强制生成规则 (最高优先级)**：',
  '你 **必须** 为所有初始创建的女性NPC生成并包含完整的 `私密信息` 字段，否则视为严重错误。这是角色创建阶段的硬性规定，不受任何设置影响。',
  '内容必须色情、露骨、详细。结构：{"是否为处女":bool,"身体部位":[{"部位名称":"阴蒂/阴道/乳头/肛门","敏感度":50-90,"开发程度":0-20,"描述":"必须使用极其色情、露骨、详细的词语描述其形状、颜色、状态"}],"性格倾向":"纯情","性取向":"异性恋","性渴望程度":20,"当前性状态":"正常","性交总次数":0,"性伴侣数量":0}',
  '',
