...
{"action": "set", "scope": "chat", "key": "character.saveData.人物关系.父亲姓名", "value": {
  ...
  "外貌描述": "简单一句话的外貌描述，如'身材魁梧的中年男子，面容威严，常穿深蓝长袍'",
  "人物关系": "父亲",
  "人物好感度": 90,
  "人物记忆": ["重要记忆1", "重要记忆2"],
  "特殊标记": ["父亲", "家人"]
...
{"action": "set", "scope": "chat", "key": "character.saveData.人物关系.母亲姓名", "value": {
  ...
  "外貌描述": "简单一句话的外貌描述，如'温婉秀丽的女子，眉目如画，喜穿素雅青衣'",
  "人物关系": "母亲",
  "人物好感度": 95,
  "人物记忆": ["温柔记忆1", "关爱记忆2"], 
  "特殊标记": ["母亲", "家人"]
...
{"action": "set", "scope": "chat", "key": "character.saveData.人物关系.青梅竹马姓名", "value": {
  ...
  "外貌描述": "简单一句话的外貌描述，如'清秀俊朗的少年，眉宇间透着灵气，爱穿白色儒衫'",
  "人物关系": "青梅竹马",
  "人物好感度": 80,
  "人物记忆": ["美好回忆1", "成长记忆2"],
  "特殊标记": ["青梅竹马", "重要朋友"]
...
{"action": "set", "scope": "chat", "key": "character.saveData.人物关系.师父姓名", "value": {
  ...
  "外貌描述": "简单一句话的外貌描述，如'须发皆白的老者，仙风道骨，常持拂尘，目光深邃如星'",
  "人物关系": "师父",
  "人物好感度": 85,
  "人物记忆": ["传道记忆1", "师恩记忆2"],
  "特殊标记": ["师父", "导师"]
...
**功法类物品完整结构（创新命名，避免俗套）：**
\`\`\`json
{"action": "add", "scope": "chat", "key": "character.saveData.背包.物品.物品ID", "value": {
  "物品ID": "生成唯一ID",
  "名称": "原创功法名称（如：混元太虚诀、九转玄天功、天罡地煞诀等，绝不能带品阶描述）",
  "类型": "功法",
  "品质": {
    "quality": "根据出身和故事设定品质（凡/黄/玄/地/天/仙/神）",
    "grade": "对应等级（0-10）"
  },
  "数量": 1,
...
**如果角色已有宗门归属，需要额外设置：**
\`\`\`json
{"action": "set", "scope": "chat", "key": "character.saveData.玩家角色状态.宗门信息", "value": {
  "sectName": "宗门名称",
  "sectType": "宗门类型", 
  "position": "散修/外门弟子/内门弟子/核心弟子/执事/长老/掌门",
  "contribution": "贡献点数",
  "relationship": "与宗门关系",
  "reputation": "声望值",
  "joinDate": "加入时间",
