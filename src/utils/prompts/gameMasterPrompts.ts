...
**初始物品添加（每个物品一条指令）：**
\`\`\`json
{"action": "set", "scope": "chat", "key": "character.saveData.背包.物品.物品唯一ID1", "value": {
  "物品ID": "物品唯一ID1",
  "名称": "具体物品名称",
  "类型": "法宝/功法/其他",
  "品质": {
...
{"action": "set", "scope": "chat", "key": "character.saveData.背包.物品.物品唯一ID2", "value": {
  "物品ID": "物品唯一ID2", 
  "名称": "另一个物品名称",
  "类型": "功法/其他",
  "品质": {
