...
**【物品操作方式】**
- 添加新物品: {"action":"set", "key":"背包.物品.{物品ID}", "value":{完整物品对象}}
- 删除物品: {"action":"delete", "key":"背包.物品.{物品ID}"}
- 修改物品数量: {"action":"add", "key":"背包.物品.{物品ID}.数量", "value":增减值}
- 修改物品属性: {"action":"set", "key":"背包.物品.{物品ID}.属性名", "value":"新值"}

示例：
- 添加物品: {"action":"set", "key":"背包.物品.item_jade_001", "value":{"物品ID":"item_jade_001","名称":"血玉","类型":"其他","品质":{"quality":"玄","grade":5},"数量":1,"描述":"一块染血的玉佩"}}
- 修改描述: {"action":"set", "key":"背包.物品.item_jade_001.描述", "value":"玉佩上的血渍已被灵气净化"}
- 修改使用效果: {"action":"set", "key":"背包.物品.item_jade_001.使用效果", "value":"可以注入灵气激活"}
- 增加数量: {"action":"add", "key":"背包.物品.item_jade_001.数量", "value":1}
...
**示例 - 正确做法：**
\`\`\`json
{"action":"set", "key":"人物关系.张三", "value":{"名字":"张三","性别":"男","年龄":25,"出生日期":{"年":975,"月":3,"日":15},"种族":"人族","出生":"散修","外貌描述":"...","性格特征":["..."],"境界":{"名称":"筑基","阶段":"初期"},"灵根":{"名称":"火灵根","品级":"中品"},"天赋":[],"先天六司":{"根骨":5,"灵性":6,"悟性":5,"气运":4,"魅力":5,"心性":6},"与玩家关系":"陌生人","好感度":0,"人格底线":["..."],"记忆":[],"记忆总结":[],"当前位置":{"描述":"...","x":5000,"y":5000},"势力归属":"无","当前外貌状态":"...","当前内心想法":"...","背包":{"灵石":{"下品":0,"中品":0,"上品":0,"极品":0},"物品":{}},"实时关注":false}}
\`\`\`
