...
- **示例结构**:
  \`\`\`json
  {"action":"set", "key":"三千大道.大道列表.剑道", "value":{"道名":"剑道","描述":"以剑入道，追求剑之极致","是否解锁":true,"当前阶段":0,"当前经验":0,"总经验":0,"阶段列表":[{"名称":"初窥门径","描述":"...","突破经验":100},{"名称":"小有所成","描述":"...","突破经验":500}]}}
  \`\`\`
`.trim()
...
### 正确格式
\`\`\`json
{"action":"set", "key":"人物关系.李云.境界", "value":{"名称":"筑基","阶段":"中期"}}
\`\`\`

### 错误格式
\`\`\`
❌ {"action":"set", "key":"人物关系.李云.境界.阶段", "value":"中期"}
❌ {"action":"set", "key":"人物关系.李云.境界.名称", "value":"筑基"}
\`\`\`
...
\`\`\`json
{"action":"set", "key":"玩家角色状态.位置", "value":{"描述":"大陆·区域·具体地点","x":5000,"y":5000}}
\`\`\`
...
\`\`\`json
[
  {"action":"set", "key":"背包.物品.gongfa_qingyun_001", "value":{"物品ID":"gongfa_qingyun_001","名称":"青云剑诀","类型":"功法","品质":{"quality":"玄","grade":6},"数量":1,"描述":"青云宗入门剑法...","功法效果":"修炼速度提升50%，剑气威力增加","功法技能":[{"技能名称":"青云剑气","技能描述":"凝聚剑气攻击","熟练度要求":0,"消耗":"灵气20"},{"技能名称":"御剑术","技能描述":"御使飞剑","熟练度要求":30,"消耗":"灵气50"}],"修炼进度":0,"已解锁技能":["青云剑气"],"已装备":true}},
  {"action":"set", "key":"修炼功法", "value":{"物品ID":"gongfa_qingyun_001","名称":"青云剑诀"}}
]
\`\`\`
