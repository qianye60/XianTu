...
// 完整写法（也可以）
{"action":"set","key":"人物关系.李云.境界","value":{"名称":"筑基","阶段":"中期","当前进度":0,"下一级所需":1000}}
\`\`\`
...
\`\`\`json
[
  {"action":"set","key":"背包.物品.gongfa_qingyun_001","value":{
    "物品ID":"gongfa_qingyun_001",
    "名称":"青云剑诀",
    "类型":"功法",
    "品质":{"quality":"玄","grade":6},
    "数量":1,
    "描述":"青云宗入门剑法...",
    "功法效果":"修炼速度提升50%，剑气威力增加",
    "功法技能":[
      {"技能名称":"青云剑气","技能描述":"凝聚剑气攻击","熟练度要求":0,"消耗":"灵气20"},
      {"技能名称":"御剑术","技能描述":"御使飞剑","熟练度要求":30,"消耗":"灵气50"}
    ],
    "修炼进度":0,
    "已解锁技能":["青云剑气"],
    "已装备":true
