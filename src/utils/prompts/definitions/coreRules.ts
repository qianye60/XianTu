...
□ 大道感悟 → add 角色.修炼.三千大道.{道名}.当前经验
□ 大道解锁 → set 角色.修炼.三千大道.{道名} (完整DaoData,当前阶段从1开始)
□ 大道升阶 → set 角色.修炼.三千大道.{道名}.当前阶段 (数值+1)
...
[大道指令示例](重要)
新悟大道:{"action":"set","key":"角色.修炼.三千大道.剑道","value":{"道名":"剑道","当前阶段":1,"当前经验":0,"总经验":0,"阶段列表":[{"名称":"入门","突破经验":100},{"名称":"初窥","突破经验":300}],"感悟记录":[],"关联":{"功法":[],"技能":[]}}}
增加经验:{"action":"add","key":"角色.修炼.三千大道.剑道.当前经验","value":50}
阶段突破:{"action":"set","key":"角色.修炼.三千大道.剑道.当前阶段","value":2}
`.trim()
...
字数要求(CRITICAL):text正文建议1000-1500字,重要场景可到1000字;不得少于800字;避免为凑字数重复环境描写
