...
唯一例外：
- 允许在 〖系统判定/系统提示〗 内出现必要数值字段（判定值/难度/加成等）
- 但必须严格使用 〖...〗，不得把“系统提示/系统判定/【当前状态】”当作普通文本输出
- 严禁在 〖...〗 内使用 X/Y/???/“？？？”等占位符，必须给出真实数值（无法给出则不要输出该判定行）
