  ...
  **修仙宗门势力命名原则**:
  - 🎋 **传统古韵**: 使用具有古典韵味的字词组合，体现深厚底蕴
  - 📿 **意境深远**: 体现修仙追求，展现宗门理念和修炼哲学
  - ⚗️ **专长特色**: 结合势力专长，体现宗门独特的修炼方向
  - 🌌 **自然元素**: 融入山水天象，展现与自然的和谐关系
  - 🚫 **严禁使用**: 绝对禁止使用法宝、道具类名称作为宗门名

  **命名风格指导**:
  - 宗门类：结合宗门特色和地理位置，体现修仙传承
  - 世家类：突出血脉传承和家族历史
  - 联盟类：体现松散组织和共同目标
  - 各类势力名称都应具有独特性，避免套路化命名
  ...
  **数据一致性验证**:
  - memberCount.total 必须等于 byPosition 所有职位的总和
  - **leadership.宗主修为 通常就是 leadership.最强修为**，体现宗主作为宗门最强者的地位
  - **只有底蕴深厚的超级宗门或一流宗门**才可能存在修为高于宗主的太上长老
  - **大部分宗门（二流、三流）的宗主就是最强者**，不需要设置更高的最强修为
  - 仅依据宗门等级（几流）体现实力层级，无需数值评分
  - 所有数值字段都必须是数字类型，不能是字符串

  **宗门境界分布指导原则** (符合修仙世界设定):
  
  宗门等级与修为层级应当符合修仙小说的基本逻辑：
  - **宗主是宗门的核心领导，通常也是最强者之一**，负责宗门的重大决策和对外征战
  - **绝大多数宗门的宗主就是最强修为者**，这是其能够统领宗门的重要原因
  - 太上长老等隐世职位**并非所有宗门都有**，只有历史悠久、底蕴深厚的大宗门才可能存在
  - 如果存在太上长老，其修为可能高于宗主，但这种情况**应该较为罕见**
  - "最强修为"字段应反映宗门内的实际最高战力，**通常就是宗主修为**
  - 不同等级宗门的实力差距应该明显且合理
  - 弟子境界分布应呈金字塔结构，低境界人数多，高境界人数少
  ...
  **重要提醒**:
  ...
  - 🔴 **修为分布约束：** 宗主通常是宗门最强者，只有少数顶级宗门才可能存在太上长老等修为更高的隐世强者
  - 🔴 **最强修为字段：** leadership.最强修为 在大多数情况下应该等于宗主修为，只有超级或一流宗门才可能更高
