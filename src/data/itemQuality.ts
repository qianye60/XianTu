...
export const ITEM_QUALITY_SYSTEM: ItemQualitySystem = {
  qualities: {
    ...
    黄: { color: "#FFD700", rarity: "修真界广泛流通的珍品，虽不顶尖，但已具备不凡效力。" },
...
### **品质等级 (从低到高):**
- **凡**: ${ITEM_QUALITY_SYSTEM.qualities.凡.rarity}
- **黄**: ${ITEM_QUALITY_SYSTEM.qualities.黄.rarity}
- **玄**: ${ITEM_QUALITY_SYSTEM.qualities.玄.rarity}
- **地**: ${ITEM_QUALITY_SYSTEM.qualities.地.rarity}
- **天**: ${ITEM_QUALITY_SYSTEM.qualities.天.rarity}
- **仙**: ${ITEM_QUALITY_SYSTEM.qualities.仙.rarity}
- **神**: ${ITEM_QUALITY_SYSTEM.qualities.神.rarity}
